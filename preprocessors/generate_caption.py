...
def parse_args():
    ...
    # LLM argument
    parser.add_argument('--image_path', type=str, default="/share/edc/home/yujielu/MPP_data/test_config/wikihow/u-plan/", help='image path')
...
if __name__ == "__main__":
    opt = parse_args()
    generate_caption(opt.image_path)
